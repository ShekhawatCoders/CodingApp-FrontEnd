...
object Parser {
    ...
    fun getCSpan(code: String): HashMap<String, ArrayList<Pair>> {

        val map = hashMapOf<String, ArrayList<Pair>>()
        map["Keyword"] = arrayListOf()
        map["Comment"] = arrayListOf()
        map["SemiColon"] = arrayListOf()
        ...
        while (i < code.length) {
            ...
            if (x == ' ' || x == '(') {
                ...
                if(keyword.contains(temp)) {
                    map["Keyword"]?.add(Pair(i-curr.length,i))
                }
                curr.clear()
                i += 1
            } else if (x == '"') {
    ...
    fun getJavaSpan(code: String): HashMap<String, ArrayList<Pair>> {
    ...
    fun getPythonSpan(code: String): HashMap<String, ArrayList<Pair>> {
