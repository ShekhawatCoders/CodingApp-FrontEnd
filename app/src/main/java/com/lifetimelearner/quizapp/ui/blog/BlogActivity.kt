...
class BlogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tag = intent.getStringExtra("BLOG_TAG") ?: ""

        progressBar = findViewById(R.id.blog_progress_bar)
        progressBar.show()
    ...
    private fun loadBlog(tag: String) {
        // now it is time to show questions here
        val url = "https://quiz-app-7663.herokuapp.com/blog?tag=$tag"
