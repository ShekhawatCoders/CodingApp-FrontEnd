...
import com.codeLearningApp.coding.ui.code.RunCodeActivity
...
class CodeRecyclerAdapter(val context: Context, private val ARG_PARAM1: String):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val runBtn = holder.itemView.findViewById<MaterialButton>(R.id.card_code_run)
        ...
        runBtn.setOnClickListener {
            val code = Intent(context, RunCodeActivity::class.java).apply {
                action = Intent.ACTION_SEND
                type = "text/plain"
                putExtra("Code", code.codeCode)
            }
